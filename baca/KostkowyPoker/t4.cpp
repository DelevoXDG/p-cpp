...
int main()
{
    ...
    while (rCount < rounds)
    {
        ...
        cout << "Round" << rCount + 1 << endl;
        cout << "Player " << p1 << ":   " << result1 << " <--- " << d11 << " " << d12 << " " << d13 << " " << d14 << " [ max: " << max1 << " pairs: " << pairs1 << " ]" << endl;
        cout << "Player " << p2 << ":   " << result2 << " <--- " << d21 << " " << d22 << " " << d23 << " " << d24 << " [ max: " << max2 << " pairs: " << pairs2 << " ]" << endl;
